...
#define HID_REPORT_SCROLL_Y     3
#define HID_REPORT_SCROLL_X     4
...
USBDHIDMouseStateChange(void *pvInstance, char cDeltaX, char cDeltaY,
                        unsigned char ucButtons, char scrollY, char scrollX)
{
    ...
    psInst->pucReport[HID_REPORT_SCROLL_Y] = scrollY;
    psInst->pucReport[HID_REPORT_SCROLL_X] = scrollX;
